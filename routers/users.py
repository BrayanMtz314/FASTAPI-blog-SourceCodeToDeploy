...
async def update_user(
    ...
    # check that the enter username doesn't exist in the database
    ...
    # check that the enter email doesn't exist in the database
    ...
    # manual way to update only the provided field.
